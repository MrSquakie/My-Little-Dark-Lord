...
namespace Gaia
{
    ...
    public class GaiaLightingProfileValues
    {
        ...
        public Color m_hDPBSAirAttenuation = new Color(0.1724138f, 0.07407407f, 0.03021148f);
        public Color m_hDPBSAirAlbedo = new Color(0.9019608f, 0.9019608f, 0.9019608f);
        public float m_hDPBSAirMaximumAltitude = 70f;
        public float m_hDPBSAerosolAttenuatonDistance = 0.5f;
        public float m_hDPBSAerosolAlbedo = 0.9f;
        ...
        public Color m_hDPBSGroundColor = new Color(0.5803922f, 0.6313726f, 0.6901961f);

...
namespace Gaia
{
    ...
    public class StamperEditor : PWEditor, IPWEditor
    {
        ...
        private void DrawStamperMaskListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            ImageMaskListEditor.DrawMaskListElement(rect, index, m_stamper.m_settings.m_imageMasks[index], ref m_collisionMaskListBeingDrawn, m_editorUtils, Terrain.activeTerrain, GaiaUtils.IsStampOperation(m_stamper.m_settings.m_operation));
        }
        ...
        private void DrawStamperControls(bool showHelp)
        {
            ...
            else
            {
                ...
                if (GUILayout.Button(GetLabel("Stamp")))
                {
                    ...
                    if (m_gaiaSettings.m_stamperAutoHidePreviewMilliseconds > 0)
                    {

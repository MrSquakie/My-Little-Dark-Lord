...
namespace Gaia
{
    ...
    public class GaiaSessionManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(20);
            EditorGUILayout.HelpBox("The session management and random terrain generation are currently still under construction, you will soon find controls here to review and undo single steps in your session as well as the ability to generate random terrains from scratch. ", MessageType.Info);

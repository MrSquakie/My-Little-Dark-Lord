...
namespace Gaia
{
    ...
    public class BiomeControllerEditor : PWEditor
    {
        ...
        {
            ImageMaskListEditor.DrawMaskListElement(rect, index, m_biomeController.m_biomeMasks[index], ref m_collisionMaskListBeingDrawn, m_editorUtils, Terrain.activeTerrain, false);
        }

...
{
    [System.Serializable]
    public class ResourceProtoGeNaSpawnerInstance
    {
    ...
    [System.Serializable]
    public class ResourceProtoGeNaSpawner
    {
        public string m_name;
        public ResourceProtoGeNaSpawnerInstance[] m_instances = new ResourceProtoGeNaSpawnerInstance[0];
        ...
        public bool SetAssetAssociations()
        {
            ...
            #if UNITY_EDITOR
            ResourceProtoGeNaSpawnerInstance goInstance;

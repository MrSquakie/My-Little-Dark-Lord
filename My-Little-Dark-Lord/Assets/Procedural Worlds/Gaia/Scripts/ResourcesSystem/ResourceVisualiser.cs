    ...
    public class ResourceVisualiser : MonoBehaviour {
        ...
        public void Initialise()
        {
            ...
            if (m_spawner == null)
            {
                ...
                m_spawner.m_settings.m_resources = m_resources;
        ...
        public float GetFitness(ref SpawnInfo spawnInfo)
        {
            ...
            switch (m_selectedResourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_selectedResourceIdx].m_spawnCriteria;
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_texturePrototypes[m_selectedResourceIdx].m_spawnCriteria;
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_selectedResourceIdx].m_spawnCriteria;
                        break;
                    }
                default:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_selectedResourceIdx].m_spawnCriteria;
                        break;
                    }
            }
        ...
        public float GetMinFitness(ref SpawnInfo spawnInfo)
        {
            ...
            switch (m_selectedResourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        if (m_selectedResourceIdx >= spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes.Length)
                        {
                            return 0f;
                        }
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_selectedResourceIdx].m_spawnCriteria;
                ...
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        if (m_selectedResourceIdx >= spawnInfo.m_spawner.m_settings.m_resources.m_texturePrototypes.Length)
                        {
                            return 0f;
                        }
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_texturePrototypes[m_selectedResourceIdx].m_spawnCriteria;
                ...
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        if (m_selectedResourceIdx >= spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes.Length)
                        {
                            return 0f;
                        }
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_selectedResourceIdx].m_spawnCriteria;
                ...
                default:
                    {
                        if (m_selectedResourceIdx >= spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes.Length)
                        {
                            return 0f;
                        }
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_selectedResourceIdx].m_spawnCriteria;
        ...
        public float GetMaxScaledRadius(ref SpawnInfo spawnInfo)
        {
            ...
            //    case GaiaConstants.SpawnerResourceType.TerrainDetail:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_selectedResourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_selectedResourceIdx].m_dna.m_maxScale;
            //        }
            //    case GaiaConstants.SpawnerResourceType.TerrainTree:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_selectedResourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_selectedResourceIdx].m_dna.m_maxScale;
            //        }
            //    default:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_selectedResourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_selectedResourceIdx].m_dna.m_maxScale;
            //        }
            //}
            return 0f;
        }
        ...
        void OnDrawGizmos()
        {
            ...
            if (m_resources != null)
            {
                ...
                {
                    bounds.center = new Vector3(bounds.center.x, GaiaSessionManager.GetSessionManager().GetSeaLevel(), bounds.center.z);

...
namespace Gaia {
    ...
    public class HydraulicErosionSettings {
        ...
        [SerializeField]
        public TerrainFloatMinMaxValue m_HydroTimeDelta = new TerrainFloatMinMaxValue(ErosionStyles.m_TimeDelta, 0.3f, 0.0f, 0.1f);
        [SerializeField]
        public TerrainIntMinMaxValue m_HydroIterations = new TerrainIntMinMaxValue(ErosionStyles.m_NumIterations, 100, 1, 500);
        [SerializeField]
        ...
        [SerializeField]
        public TerrainFloatMinMaxValue m_SimScale = new TerrainFloatMinMaxValue(ErosionStyles.m_SimulationScale, 1.0f, 0.0f, 100.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_IterationBlendScalar = new TerrainFloatMinMaxValue(ErosionStyles.m_IterationBlendScalar, 1.0f, -1.0f, 1.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_PrecipRate = new TerrainFloatMinMaxValue(ErosionStyles.m_PrecipitationRate, 0.4f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_EvaporationRate = new TerrainFloatMinMaxValue(ErosionStyles.m_EvaporationRate, 0.4f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_FlowRate = new TerrainFloatMinMaxValue(ErosionStyles.m_FlowRate, 0.4f, 0.0f, 10.0f);
        ...
        [SerializeField]
        public TerrainFloatMinMaxValue m_SedimentCapacity = new TerrainFloatMinMaxValue(ErosionStyles.m_SedimentCap, 0.42f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_SedimentDissolveRate = new TerrainFloatMinMaxValue(ErosionStyles.m_SedimentDissolve, 0.51f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_SedimentDepositRate = new TerrainFloatMinMaxValue(ErosionStyles.m_SedimentDeposit, 0.4f, 0.0f, 10.0f);

        [SerializeField]
        public TerrainFloatMinMaxValue m_RiverBankDissolveRate = new TerrainFloatMinMaxValue(ErosionStyles.m_RiverbankDissolve, 2.0f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_RiverBankDepositRate = new TerrainFloatMinMaxValue(ErosionStyles.m_RiverbankDeposit, 8.0f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_RiverBedDissolveRate = new TerrainFloatMinMaxValue(ErosionStyles.m_RiverbedDissolve, 8.0f, 0.0f, 10.0f);
        [SerializeField]
        public TerrainFloatMinMaxValue m_RiverBedDepositRate = new TerrainFloatMinMaxValue(ErosionStyles.m_RiverbedDeposit, 2.0f, 0.0f, 10.0f);
        ...
        [SerializeField]
        public TerrainFloatMinMaxValue m_MaterialSpread = new TerrainFloatMinMaxValue(ErosionStyles.m_MaterialSpread, 0.5f, 0.0f, 1.0f);
        [SerializeField]

...
{
    /// <summary>
    /// Class used to generate fractal noise
    /// </summary>
    [System.Serializable]
    public class Fractal
    {
        ...
        /// </summary>
        public enum GeneratedFractalType { Perlin, Billow, RidgeMulti };

        /// <summary>
        /// Seed - different seeds generate replicable different fractals
        /// </summary>
        [SerializeField] private float m_seed = 0;
        public float Seed
        {
            get { return m_seed; }
            set { m_seed = value; }
        ...
        /// </summary>
        [SerializeField] private float m_persistence = 0.65f;
        ...
        /// </summary>
        [SerializeField] private float m_frequency = 0.05f;
        ...
        /// </summary>
        [SerializeField] private float m_lacunarity = 1.5f;
        ...
        /// </summary>
        private GeneratedFractalType m_fractalType = GeneratedFractalType.Perlin;
        ...
        public float GetValue_Perlin(float x, float z)
        {
            ...
            for (int octave = 0; octave < m_octaves; octave++)
            {
                nx = x;
                nz = z;
                signal = GeNa.NoiseGenerator.Generate(nx, nz);
        ...
        public float GetValue_Billow(float x, float z)
        {
            ...
            for (int octave = 0; octave < m_octaves; octave++)
            {
                nx = x;
                nz = z;
                signal = NoiseGenerator.Generate(nx, nz);

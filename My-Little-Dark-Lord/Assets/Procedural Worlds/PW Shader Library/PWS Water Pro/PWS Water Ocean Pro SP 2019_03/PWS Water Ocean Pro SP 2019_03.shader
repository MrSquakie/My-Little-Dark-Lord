...
Shader "PWS/Water/Ocean Pro SP 2019_03 v3.1"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float screenDepth2739 = (SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy )*( _ProjectionParams.z - _ProjectionParams.y ));
			...
			float2 uv_TexCoord4_g2039 = i.uv_texcoord * temp_cast_13;
			float2 _Vector0 = float2(2,4);
			float cos5_g2039 = cos( _Vector0.x );
			float sin5_g2039 = sin( _Vector0.x );
			float2 rotator5_g2039 = mul( uv_TexCoord4_g2039 - float2( 0,0 ) , float2x2( cos5_g2039 , -sin5_g2039 , sin5_g2039 , cos5_g2039 )) + float2( 0,0 );
			float2 panner10_g2039 = ( 1.0 * _Time.y * temp_cast_12 + rotator5_g2039);
			float2 temp_cast_14 = (_OceanFoamSpeed).xx;
			float cos6_g2039 = cos( _Vector0.y );
			float sin6_g2039 = sin( _Vector0.y );
			float2 rotator6_g2039 = mul( uv_TexCoord4_g2039 - float2( 0,0 ) , float2x2( cos6_g2039 , -sin6_g2039 , sin6_g2039 , cos6_g2039 )) + float2( 0,0 );
			float2 panner11_g2039 = ( 1.0 * _Time.y * temp_cast_14 + rotator6_g2039);
			float2 temp_cast_15 = (_OceanFoamSpeed).xx;
			float2 panner8_g2039 = ( 1.0 * _Time.y * temp_cast_15 + uv_TexCoord4_g2039);
			float4 tex2DNode14_g2039 = tex2D( _OceanFoamMap, panner8_g2039 );
			float3 unityObjectToViewPos38_g2039 = UnityObjectToViewPos( ase_vertex3Pos );
			float Screen_depth2306 = localCorrectedLinearEyeDepth6_g2028;
			float temp_output_39_0_g2039 = ( unityObjectToViewPos38_g2039.z + Screen_depth2306 );
			...
			float temp_output_44_0_g2039 = Screen_closeness2373;
			float4 lerpResult49_g2039 = lerp( float4( 0,0,0,0 ) , ( _OceanFoamTint * Screen_depth_behind2369 * ( ( tex2D( _OceanFoamMap, panner10_g2039 ) + tex2D( _OceanFoamMap, panner11_g2039 ) + tex2DNode14_g2039 ) / 3.0 ) ) , saturate( ( ( ( temp_output_39_0_g2039 - 0.001 ) * temp_output_44_0_g2039 ) / ( ( _foamMax2 - 0.001 ) * temp_output_44_0_g2039 ) ) ));
			float4 lerpResult25_g2039 = lerp( float4( 0,0,0,0 ) , lerpResult49_g2039 , _OceanFoamStrength);
			float4 temp_cast_16 = (0.0).xxxx;
			#if defined(_ENABLEOCEANFOAM1_ON)
				float4 staticSwitch33_g2039 = lerpResult25_g2039;
			#elif defined(_ENABLEOCEANFOAM1_OFF)
				float4 staticSwitch33_g2039 = temp_cast_16;
			#else
				float4 staticSwitch33_g2039 = lerpResult25_g2039;
			#endif
			float4 PWSFOceanFoam302 = staticSwitch33_g2039;
			...
			float _176_g2040 = localGetGeometricNormalVariance9_g2038;
			float switchResult16_g2038 = (((i.ASEVFace>0)?(1.0):(localGetGeometricNormalVariance9_g2038)));
			float _1171_g2040 = switchResult16_g2038;
			float ENUM173_g2040 = (float)_SmoothnessMode;
			float lerpResult275_g2040 = lerp( _176_g2040 , _1171_g2040 , saturate( ENUM173_g2040 ));
			float switchResult7_g2038 = (((i.ASEVFace>0)?(localGetGeometricNormalVariance9_g2038):(0.0)));
			float _2170_g2040 = switchResult7_g2038;
			float lerpResult271_g2040 = lerp( lerpResult275_g2040 , _2170_g2040 , saturate( ( ENUM173_g2040 - 1.0 ) ));
			half THREE27_g2040 = lerpResult271_g2040;
			float PWSFSmoothnessGeometricSpecular2432 = THREE27_g2040;
			...
			float temp_output_79_0_g2041 = _NormalMapWorld1987.x;
			float3 temp_cast_30 = (temp_output_79_0_g2041).xxx;
			float3 indirectNormal76_g2041 = WorldNormalVector( i , temp_cast_30 );
			float temp_output_29_0_g2041 = (_HighlightTint1).a;
			Unity_GlossyEnvironmentData g76_g2041 = UnityGlossyEnvironmentSetup( temp_output_29_0_g2041, data.worldViewDir, indirectNormal76_g2041, float3(0,0,0));
			float3 indirectSpecular76_g2041 = UnityGI_IndirectSpecular( data, _Occlusion, indirectNormal76_g2041, g76_g2041 );
			float3 lerpResult53_g2041 = lerp( temp_cast_28 , indirectSpecular76_g2041 , ( 1.0 - _LightIndirectStrengthSpecular1 ));
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 temp_output_35_0_g2041 = ( ase_lightColor.rgb * float3( 0,0,0 ) );
			float temp_output_78_0_g2041 = _PWSFNdotL2044;
			float _176_g2042 = temp_output_78_0_g2041;
			float3 normalizeResult7_g2041 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float3 temp_cast_31 = (temp_output_79_0_g2041).xxx;
			float dotResult11_g2041 = dot( normalizeResult7_g2041 , temp_cast_31 );
			float _1171_g2042 = dotResult11_g2041;
			float ENUM173_g2042 = (float)_HighlightDirection;
			float lerpResult265_g2042 = lerp( _176_g2042 , _1171_g2042 , saturate( ENUM173_g2042 ));
			float4 wave93_g2029 = _Wave03;
			float temp_output_41_0_g2029 = ( _WaveSpeed + PWSF_GlobalWindIntensityWater );
			float wspeed93_g2029 = temp_output_41_0_g2029;
			float3 p93_g2029 = ase_vertex3Pos;
			...
			float dotResult8_g2041 = dot( normalizeResult7_g2041 , temp_cast_34 );
			float _2170_g2042 = dotResult8_g2041;
			float temp_output_263_0_g2042 = ( ENUM173_g2042 - 1.0 );
			float lerpResult258_g2042 = lerp( lerpResult265_g2042 , _2170_g2042 , saturate( temp_output_263_0_g2042 ));
			float3 temp_cast_36 = (_NormalMapAnimated982.x).xxx;
			float dotResult10_g2041 = dot( normalizeResult7_g2041 , temp_cast_36 );
			float _3169_g2042 = dotResult10_g2041;
			float lerpResult262_g2042 = lerp( lerpResult258_g2042 , _3169_g2042 , saturate( ( temp_output_263_0_g2042 - 1.0 ) ));
			half FOUR16_g2042 = lerpResult262_g2042;
			float3 INDIRECT_SPECULAR4004 = ( lerpResult53_g2041 * temp_output_35_0_g2041 * pow( temp_output_29_0_g2041 , 1.5 ) * saturate( ( ( FOUR16_g2042 + _HighlightOffset1 ) / ( ( 1.0 - _HighlightTint1.a ) * ( 1.0 - _HighlightSharpness1 ) ) ) ) * (_HighlightTint1).rgb );
			float3 temp_cast_37 = (1.0).xxx;
			float3 temp_cast_38 = (temp_output_78_0_g2041).xxx;
			UnityGI gi83_g2041 = gi;
			float3 diffNorm83_g2041 = WorldNormalVector( i , temp_cast_38 );
			gi83_g2041 = UnityGI_Base( data, 1, diffNorm83_g2041 );
			float3 indirectDiffuse83_g2041 = gi83_g2041.indirect.diffuse + diffNorm83_g2041 * 0.0001;
			float3 lerpResult45_g2041 = lerp( temp_cast_37 , indirectDiffuse83_g2041 , ( 1.0 - _LightIndirectStrengthDiffuse1 ));
			float temp_output_33_0_g2041 = ( 1.0 - ( ( 1.0 - ase_lightAtten ) * _WorldSpaceLightPos0.w ) );
			float lerpResult48_g2041 = lerp( temp_output_33_0_g2041 , ( saturate( ( ( temp_output_78_0_g2041 + _ShadowOffset1 ) / _ShadowSharpness1 ) ) * ase_lightAtten ) , _ShadowStrength1);
			float3 LIGHT_SHADOWS4005 = saturate( ( ( lerpResult45_g2041 * ase_lightColor.a * temp_output_33_0_g2041 ) + ( ase_lightColor.rgb * lerpResult48_g2041 ) ) );
			float3 temp_cast_39 = (0.0).xxx;
			float3 specColor14_g2043 = temp_cast_39;
			float3 temp_cast_41 = (ColorTintFinal444.r).xxx;
			float3 grazingTerm14_g2043 = temp_cast_41;
			float dotResult5_g2043 = dot( ase_worldNormal , ase_worldViewDir );
			float nv14_g2043 = dotResult5_g2043;
			float localCallFresnelLerpFast14_g2043 = CallFresnelLerpFast( specColor14_g2043 , grazingTerm14_g2043 , nv14_g2043 );
			float Opacity2371 = ( i.vertexColor.a * ( 1.0 - _OpacityOcean ) );
			float PWSFLightingReduceatHorizon3992 = max( 0.0 , ( 1.0 - ( localCallFresnelLerpFast14_g2043 * Opacity2371 ) ) );
...
/*ASEBEGIN
Version=17300
1920;146;1664;826;6652.767;5774.669;3.37449;True;True
...
Node;AmplifyShaderEditor.Vector4Node;3967;-2964.737,-3372.167;Float;False;Global;_CameraDepthTexture_TexelSize;_CameraDepthTexture_TexelSize;2;0;Create;True;0;0;True;0;0,0,0,0;0.0004378284,0.0009560229,2284,1046;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DepthFade;2739;-5187.934,-5379.033;Inherit;False;False;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3944;-5206.646,-4302.642;Inherit;False;PWSF Water Foam Ocean v3.0;58;;2039;3bf6834ee5afdac4b9545ba41b4dcdad;0;3;30;FLOAT;0;False;44;FLOAT;0;False;36;FLOAT;0;False;2;COLOR;0;FLOAT;50
...
Node;AmplifyShaderEditor.FunctionNode;3896;-3704.902,-4540.917;Inherit;False;PWSF Enum Switch;-1;;2040;3e9cc2aefa7c15f46bb8ad0edeb00b30;1,34,1;9;134;FLOAT;0;False;146;FLOAT;0;False;133;FLOAT;0;False;144;FLOAT;0;False;143;FLOAT;0;False;155;FLOAT;0;False;156;FLOAT;0;False;150;FLOAT;0;False;158;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4014;-2613.817,-4053.054;Inherit;False;PWSF Water Custom Lighting v3.0;9;;2041;7d24d5506c1d9d048995cd814d89c1df;0;5;88;FLOAT;0;False;78;FLOAT;0;False;79;FLOAT;0;False;81;FLOAT;0;False;82;FLOAT;0;False;3;FLOAT3;74;FLOAT3;84;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3997;-4038.394,-4076.227;Inherit;False;PWSF Lighting Reduce at Horizon v3.0;-1;;2043;58046f1a7a923914eb9db82c67a2b04d;0;3;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B0AE2C744CD7C05D9FCBE164B7C201F57D417520
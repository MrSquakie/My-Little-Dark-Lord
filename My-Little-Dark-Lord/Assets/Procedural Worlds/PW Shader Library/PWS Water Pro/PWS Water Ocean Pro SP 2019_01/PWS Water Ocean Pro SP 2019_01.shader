...
Shader "PWS/Water/Ocean Pro SP 2019_01 v3.1"
{
	Properties
	{
		...
		[Enum(NdotL,0,N1,1,N1V,2,N1A,3)]_HighlightDirection("Highlight Direction", Int) = 0
		...
		_Occlusion2("Occlusion", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		uniform int _HighlightDirection;
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float temp_output_66_0_g2029 = distance( _WorldSpaceCameraPos , ase_worldPos );
			float temp_output_82_0_g2029 = ( pow( ( temp_output_66_0_g2029 / _BeachRange ) , _BeachPower ) - _BeachOffset );
			float temp_output_85_0_g2029 = saturate( temp_output_82_0_g2029 );
			float temp_output_70_0_g2029 = ( pow( ( temp_output_66_0_g2029 / _OceanRange ) , _OceanPower ) - _OceanOffset );
			float temp_output_71_0_g2029 = saturate( temp_output_70_0_g2029 );
			float4 wave92_g2029 = _Wave01;
			float temp_output_41_0_g2029 = ( _WaveSpeed + PWSF_GlobalWindIntensityWater );
			float wspeed92_g2029 = temp_output_41_0_g2029;
			float3 ase_vertex3Pos = v.vertex.xyz;
			float3 p92_g2029 = ase_vertex3Pos;
			float3 tangent92_g2029 = float3(1,0,0);
			float3 binormal92_g2029 = float3(0,0,1);
			float3 localPWSFGerstnerWaves92_g2029 = PWSFGerstnerWaves( wave92_g2029 , wspeed92_g2029 , p92_g2029 , tangent92_g2029 , binormal92_g2029 );
			float4 wave91_g2029 = _Wave02;
			float wspeed91_g2029 = temp_output_41_0_g2029;
			float3 p91_g2029 = ase_vertex3Pos;
			float3 tangent91_g2029 = tangent92_g2029;
			float3 binormal91_g2029 = binormal92_g2029;
			float3 localPWSFGerstnerWaves91_g2029 = PWSFGerstnerWaves( wave91_g2029 , wspeed91_g2029 , p91_g2029 , tangent91_g2029 , binormal91_g2029 );
			float4 wave93_g2029 = _Wave03;
			float wspeed93_g2029 = temp_output_41_0_g2029;
			float3 p93_g2029 = ase_vertex3Pos;
			float3 tangent93_g2029 = tangent91_g2029;
			float3 binormal93_g2029 = binormal91_g2029;
			float3 localPWSFGerstnerWaves93_g2029 = PWSFGerstnerWaves( wave93_g2029 , wspeed93_g2029 , p93_g2029 , tangent93_g2029 , binormal93_g2029 );
			float3 PWSFGerstnerLocalVertOffset1382 = ( ( temp_output_85_0_g2029 * _BeachIntensity ) * ( ( ( 1.0 - temp_output_71_0_g2029 ) * _OceanIntensity ) * ( ( _WaveHeightValueXYZ * _WaveHeight ) * ( localPWSFGerstnerWaves92_g2029 + localPWSFGerstnerWaves91_g2029 + localPWSFGerstnerWaves93_g2029 ) ) ) );
			v.vertex.xyz += PWSFGerstnerLocalVertOffset1382;
			float3 normalizeResult12_g2029 = normalize( cross( binormal93_g2029 , tangent93_g2029 ) );
			float3 PWSFGerstnerLocalVertNormal1384 = saturate( normalizeResult12_g2029 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 appendResult3_g2036 = (float4(ase_worldPos.x , ase_worldPos.z , 0.0 , 0.0));
			float4 temp_output_8_0_g2036 = ( ( appendResult3_g2036 / 10.0 ) * _BeachFoamTiling );
			float2 _Vector3 = float2(2,1);
			float cos18_g2036 = cos( _Vector3.x );
			float sin18_g2036 = sin( _Vector3.x );
			float2 rotator18_g2036 = mul( temp_output_8_0_g2036.xy - float2( 0,0 ) , float2x2( cos18_g2036 , -sin18_g2036 , sin18_g2036 , cos18_g2036 )) + float2( 0,0 );
			float2 panner24_g2036 = ( 1.0 * _Time.y * ( float2( 1,0 ) * _BeachFoamSpeed ) + rotator18_g2036);
			float cos17_g2036 = cos( _Vector3.y );
			float sin17_g2036 = sin( _Vector3.y );
			float2 rotator17_g2036 = mul( ( temp_output_8_0_g2036 * ( _BeachFoamTiling * 5.0 ) ).xy - float2( 0,0 ) , float2x2( cos17_g2036 , -sin17_g2036 , sin17_g2036 , cos17_g2036 )) + float2( 0,0 );
			float2 panner22_g2036 = ( 1.0 * _Time.y * ( float2( 1,0 ) * _BeachFoamSpeed ) + rotator17_g2036);
			float4 tex2DNode28_g2036 = tex2D( _BeachFoamMap, panner22_g2036 );
			float4 lerpResult36_g2036 = lerp( float4( 0,0,0,0 ) , ( tex2D( _BeachFoamMap, panner24_g2036 ) * tex2DNode28_g2036 * tex2DNode28_g2036.a * Screen_depth_behind2369 ) , _BeachFoamTint);
			float3 unityObjectToViewPos21_g2036 = UnityObjectToViewPos( ase_vertex3Pos );
			float temp_output_25_0_g2036 = ( unityObjectToViewPos21_g2036.z + Screen_depth2306 );
			float temp_output_51_0_g2036 = Screen_closeness2373;
			float4 lerpResult43_g2036 = lerp( abs( ( lerpResult36_g2036 - float4( 0,0,0,0 ) ) ) , float4( 0,0,0,0 ) , saturate( ( ( ( temp_output_25_0_g2036 - 0.001 ) * temp_output_51_0_g2036 ) / ( ( _foamMax1 - 0.001 ) * temp_output_51_0_g2036 ) ) ));
			float4 clampResult44_g2036 = clamp( lerpResult43_g2036 , float4( 0,0,0,0 ) , float4( 0.8602941,0.8602941,0.8602941,0 ) );
			float4 temp_cast_19 = (( 1.0 - _BeachFoamStrength )).xxxx;
			float4 temp_cast_20 = (0.0).xxxx;
			#if defined(_ENABLEBEACHFOAM_ON)
				float4 staticSwitch59_g2036 = pow( clampResult44_g2036 , temp_cast_19 );
			#elif defined(_ENABLEBEACHFOAM_OFF)
				float4 staticSwitch59_g2036 = temp_cast_20;
			#else
				float4 staticSwitch59_g2036 = pow( clampResult44_g2036 , temp_cast_19 );
			#endif
			float4 PWSFBeachFoam834 = staticSwitch59_g2036;
			...
			float perceptualSmoothness9_g2037 = _Smoothness;
			float3 geometricNormalWS9_g2037 = ase_worldNormal;
			float screenSpaceVariance9_g2037 = _SmoothnessVariance;
			float threshold9_g2037 = _SmoothnessThreshold;
			float localGetGeometricNormalVariance9_g2037 = GetGeometricNormalVariance( perceptualSmoothness9_g2037 , geometricNormalWS9_g2037 , screenSpaceVariance9_g2037 , threshold9_g2037 );
			float _176_g2038 = localGetGeometricNormalVariance9_g2037;
			float switchResult16_g2037 = (((i.ASEVFace>0)?(1.0):(localGetGeometricNormalVariance9_g2037)));
			float _1171_g2038 = switchResult16_g2037;
			float ENUM173_g2038 = (float)_SmoothnessMode;
			float lerpResult275_g2038 = lerp( _176_g2038 , _1171_g2038 , saturate( ENUM173_g2038 ));
			float switchResult7_g2037 = (((i.ASEVFace>0)?(localGetGeometricNormalVariance9_g2037):(0.0)));
			float _2170_g2038 = switchResult7_g2037;
			float lerpResult271_g2038 = lerp( lerpResult275_g2038 , _2170_g2038 , saturate( ( ENUM173_g2038 - 1.0 ) ));
			half THREE27_g2038 = lerpResult271_g2038;
			float PWSFSmoothnessGeometricSpecular2432 = THREE27_g2038;
			...
			float temp_output_79_0_g2039 = _NormalMapWorld1987.x;
			float3 temp_cast_30 = (temp_output_79_0_g2039).xxx;
			float3 indirectNormal76_g2039 = WorldNormalVector( i , temp_cast_30 );
			float temp_output_29_0_g2039 = (_HighlightTint1).a;
			Unity_GlossyEnvironmentData g76_g2039 = UnityGlossyEnvironmentSetup( temp_output_29_0_g2039, data.worldViewDir, indirectNormal76_g2039, float3(0,0,0));
			float3 indirectSpecular76_g2039 = UnityGI_IndirectSpecular( data, _Occlusion2, indirectNormal76_g2039, g76_g2039 );
			float3 lerpResult53_g2039 = lerp( temp_cast_28 , indirectSpecular76_g2039 , ( 1.0 - _LightIndirectStrengthSpecular1 ));
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 temp_output_35_0_g2039 = ( ase_lightColor.rgb * float3( 0,0,0 ) );
			float temp_output_78_0_g2039 = _PWSFNdotL2044;
			float _176_g2040 = temp_output_78_0_g2039;
			float3 normalizeResult7_g2039 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float3 temp_cast_31 = (temp_output_79_0_g2039).xxx;
			float dotResult11_g2039 = dot( normalizeResult7_g2039 , temp_cast_31 );
			float _1171_g2040 = dotResult11_g2039;
			float ENUM173_g2040 = (float)_HighlightDirection;
			float lerpResult265_g2040 = lerp( _176_g2040 , _1171_g2040 , saturate( ENUM173_g2040 ));
			float4 wave93_g2029 = _Wave03;
			float temp_output_41_0_g2029 = ( _WaveSpeed + PWSF_GlobalWindIntensityWater );
			float wspeed93_g2029 = temp_output_41_0_g2029;
			float3 p93_g2029 = ase_vertex3Pos;
			...
			float3 normalizeResult12_g2029 = normalize( cross( binormal93_g2029 , tangent93_g2029 ) );
			float3 PWSFGerstnerLocalVertNormal1384 = saturate( normalizeResult12_g2029 );
			float3 temp_cast_34 = (PWSFGerstnerLocalVertNormal1384.x).xxx;
			float dotResult8_g2039 = dot( normalizeResult7_g2039 , temp_cast_34 );
			float _2170_g2040 = dotResult8_g2039;
			float temp_output_263_0_g2040 = ( ENUM173_g2040 - 1.0 );
			float lerpResult258_g2040 = lerp( lerpResult265_g2040 , _2170_g2040 , saturate( temp_output_263_0_g2040 ));
			float3 temp_cast_36 = (_NormalMapAnimated982.x).xxx;
			float dotResult10_g2039 = dot( normalizeResult7_g2039 , temp_cast_36 );
			float _3169_g2040 = dotResult10_g2039;
			float lerpResult262_g2040 = lerp( lerpResult258_g2040 , _3169_g2040 , saturate( ( temp_output_263_0_g2040 - 1.0 ) ));
			half FOUR16_g2040 = lerpResult262_g2040;
			float3 INDIRECT_SPECULAR4004 = ( lerpResult53_g2039 * temp_output_35_0_g2039 * pow( temp_output_29_0_g2039 , 1.5 ) * saturate( ( ( FOUR16_g2040 + _HighlightOffset1 ) / ( ( 1.0 - _HighlightTint1.a ) * ( 1.0 - _HighlightSharpness1 ) ) ) ) * (_HighlightTint1).rgb );
			float3 temp_cast_37 = (1.0).xxx;
			float3 temp_cast_38 = (temp_output_78_0_g2039).xxx;
			UnityGI gi83_g2039 = gi;
			float3 diffNorm83_g2039 = WorldNormalVector( i , temp_cast_38 );
			gi83_g2039 = UnityGI_Base( data, 1, diffNorm83_g2039 );
			float3 indirectDiffuse83_g2039 = gi83_g2039.indirect.diffuse + diffNorm83_g2039 * 0.0001;
			float3 lerpResult45_g2039 = lerp( temp_cast_37 , indirectDiffuse83_g2039 , ( 1.0 - _LightIndirectStrengthDiffuse1 ));
			float temp_output_33_0_g2039 = ( 1.0 - ( ( 1.0 - ase_lightAtten ) * _WorldSpaceLightPos0.w ) );
			float lerpResult48_g2039 = lerp( temp_output_33_0_g2039 , ( saturate( ( ( temp_output_78_0_g2039 + _ShadowOffset1 ) / _ShadowSharpness1 ) ) * ase_lightAtten ) , _ShadowStrength1);
			float3 LIGHT_SHADOWS4005 = saturate( ( ( lerpResult45_g2039 * ase_lightColor.a * temp_output_33_0_g2039 ) + ( ase_lightColor.rgb * lerpResult48_g2039 ) ) );
			float3 temp_cast_39 = (0.0).xxx;
			float3 specColor14_g2041 = temp_cast_39;
			float3 temp_cast_41 = (ColorTintFinal444.r).xxx;
			float3 grazingTerm14_g2041 = temp_cast_41;
			...
			#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch31_g2028 = temp_cast_44;
			#else
...
/*ASEBEGIN
Version=17300
2023;108.5;1664;832;6192.558;4558.25;1.687562;True;True
...
Node;AmplifyShaderEditor.FunctionNode;4017;-5415.05,-4068.344;Inherit;False;PWSF Water Normal Map Swirling SP v3.0;26;;2025;c1b39032cbbd97a4da4a74689588ba08;0;0;2;FLOAT3;29;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector4Node;3967;-2964.737,-3372.167;Float;False;Global;_CameraDepthTexture_TexelSize;_CameraDepthTexture_TexelSize;2;0;Create;True;0;0;True;0;0,0,0,0;0.0004793864,0.001033058,2086,968;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3941;-4032.759,-3572.098;Inherit;False;PWSF Water Custom Grab Pass v3.0;-1;;2028;84db7f407c2735b4986e5ebfc2f85480;0;2;45;FLOAT;0;False;46;FLOAT;0;False;8;FLOAT;0;COLOR;38;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42;FLOAT;43;FLOAT;44
...
Node;AmplifyShaderEditor.GetLocalVarNode;1779;-5491.762,-4303.973;Inherit;False;2369;Screen_depth_behind;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4016;-4182.36,-4496.381;Inherit;False;PWSF Smoothness Geometric Specular v3.0;20;;2037;87fb58cae055bea429a44169a3c936fd;0;1;25;FLOAT;0;False;3;FLOAT;17;FLOAT;20;FLOAT;21
Node;AmplifyShaderEditor.FunctionNode;3943;-5205.442,-4587.129;Inherit;False;PWSF Water Foam Beach v3.0;66;;2036;4ddef9c0ccfa2604e9a2a38dcaf12896;0;3;51;FLOAT;0;False;52;FLOAT;0;False;53;FLOAT;0;False;2;COLOR;0;FLOAT;60
...
Node;AmplifyShaderEditor.RangedFloatNode;4015;-2972.034,-4075.645;Float;False;Property;_Occlusion2;Occlusion;24;0;Create;True;0;0;False;0;0.5;0.344;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4014;-2613.817,-4053.054;Inherit;False;PWSF Water Custom Lighting v3.0;9;;2039;7d24d5506c1d9d048995cd814d89c1df;0;5;88;FLOAT;0;False;78;FLOAT;0;False;79;FLOAT;0;False;81;FLOAT;0;False;82;FLOAT;0;False;3;FLOAT3;74;FLOAT3;84;FLOAT3;0
...
WireConnection;4014;81;4001;0
WireConnection;4014;82;4000;0
...
ASEEND*/
//CHKSM=13DEB8E8AF8879DC26D35A9591FE5AA7764CCA4C
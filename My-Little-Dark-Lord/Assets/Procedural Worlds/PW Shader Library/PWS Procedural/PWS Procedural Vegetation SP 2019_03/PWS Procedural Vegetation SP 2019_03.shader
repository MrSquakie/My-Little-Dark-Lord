...
Shader "PWS/Procedural/Vegetation SP 2019_03 v3.1"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float _176_g1723 = SquareMask72;
			float _1171_g1723 = ColorMask67;
			float ENUM173_g1723 = (float)_DebugMode;
			float lerpResult265_g1723 = lerp( _176_g1723 , _1171_g1723 , saturate( ENUM173_g1723 ));
			float temp_output_74_0_g1701 = ( saturate( ( ase_vertex3Pos.y + _WindVerticalMaskOffset ) ) * _WindVerticalMaskIntensity );
			float VerticalMask155 = temp_output_74_0_g1701;
			float _2170_g1723 = VerticalMask155;
			float temp_output_263_0_g1723 = ( ENUM173_g1723 - 1.0 );
			float lerpResult258_g1723 = lerp( lerpResult265_g1723 , _2170_g1723 , saturate( temp_output_263_0_g1723 ));
			float temp_output_23_0_g1702 = ( pow( ( distance( _WorldSpaceCameraPos , ase_worldPos ) / _WindDistanceRange ) , 1.0 ) - _WindDistanceOffset );
			float temp_output_24_0_g1702 = saturate( temp_output_23_0_g1702 );
			float temp_output_78_0_g1701 = ( ( 1.0 - temp_output_24_0_g1702 ) * 1.0 );
			float DistanceMask973 = ( 1.0 - temp_output_78_0_g1701 );
			float _3169_g1723 = DistanceMask973;
			float lerpResult262_g1723 = lerp( lerpResult258_g1723 , _3169_g1723 , saturate( ( temp_output_263_0_g1723 - 1.0 ) ));
			half FOUR16_g1723 = lerpResult262_g1723;
			float3 temp_cast_15 = (FOUR16_g1723).xxx;
			...
			float _176_g1722 = localGetGeometricNormalVariance9_g1717;
			float switchResult16_g1717 = (((i.ASEVFace>0)?(1.0):(localGetGeometricNormalVariance9_g1717)));
			float _1171_g1722 = switchResult16_g1717;
			float ENUM173_g1722 = (float)_SmoothnessMode;
			float lerpResult275_g1722 = lerp( _176_g1722 , _1171_g1722 , saturate( ENUM173_g1722 ));
			float switchResult7_g1717 = (((i.ASEVFace>0)?(localGetGeometricNormalVariance9_g1717):(0.0)));
			float _2170_g1722 = switchResult7_g1717;
			float lerpResult271_g1722 = lerp( lerpResult275_g1722 , _2170_g1722 , saturate( ( ENUM173_g1722 - 1.0 ) ));
			half THREE27_g1722 = lerpResult271_g1722;
			o.Smoothness = ( ( 1.0 - tex2D( _RoughnessTexture, uv0_MainTex ).r ) * lerpResult763 * THREE27_g1722 );
...
/*ASEBEGIN
Version=17300
1920;146;1664;826;3274.078;299.6339;1.866354;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1288;-2030.429,209.1758;Inherit;False;PWSF Enum Switch;-1;;1723;3e9cc2aefa7c15f46bb8ad0edeb00b30;1,34,2;9;134;FLOAT;0;False;146;FLOAT;0;False;133;FLOAT;0;False;144;FLOAT;0;False;143;FLOAT;0;False;155;FLOAT;0;False;156;FLOAT;0;False;150;FLOAT;0;False;158;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=1ED76DCB323039C178D3A30A23110CF8D09EF83D
...
Shader "PWS/Procedural/Vegetation SP 2019_01 v3.1"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float _176_g1724 = SquareMask72;
			float _1171_g1724 = ColorMask67;
			float ENUM173_g1724 = (float)_DebugMode;
			float lerpResult265_g1724 = lerp( _176_g1724 , _1171_g1724 , saturate( ENUM173_g1724 ));
			float temp_output_74_0_g1701 = ( saturate( ( ase_vertex3Pos.y + _WindVerticalMaskOffset ) ) * _WindVerticalMaskIntensity );
			float VerticalMask155 = temp_output_74_0_g1701;
			float _2170_g1724 = VerticalMask155;
			float temp_output_263_0_g1724 = ( ENUM173_g1724 - 1.0 );
			float lerpResult258_g1724 = lerp( lerpResult265_g1724 , _2170_g1724 , saturate( temp_output_263_0_g1724 ));
			float temp_output_23_0_g1702 = ( pow( ( distance( _WorldSpaceCameraPos , ase_worldPos ) / _WindDistanceRange ) , 1.0 ) - _WindDistanceOffset );
			float temp_output_24_0_g1702 = saturate( temp_output_23_0_g1702 );
			float temp_output_78_0_g1701 = ( ( 1.0 - temp_output_24_0_g1702 ) * 1.0 );
			float DistanceMask973 = ( 1.0 - temp_output_78_0_g1701 );
			float _3169_g1724 = DistanceMask973;
			float lerpResult262_g1724 = lerp( lerpResult258_g1724 , _3169_g1724 , saturate( ( temp_output_263_0_g1724 - 1.0 ) ));
			half FOUR16_g1724 = lerpResult262_g1724;
			float3 temp_cast_15 = (FOUR16_g1724).xxx;
			...
			float _176_g1723 = localGetGeometricNormalVariance9_g1722;
			float switchResult16_g1722 = (((i.ASEVFace>0)?(1.0):(localGetGeometricNormalVariance9_g1722)));
			float _1171_g1723 = switchResult16_g1722;
			float ENUM173_g1723 = (float)_SmoothnessMode;
			float lerpResult275_g1723 = lerp( _176_g1723 , _1171_g1723 , saturate( ENUM173_g1723 ));
			float switchResult7_g1722 = (((i.ASEVFace>0)?(localGetGeometricNormalVariance9_g1722):(0.0)));
			float _2170_g1723 = switchResult7_g1722;
			float lerpResult271_g1723 = lerp( lerpResult275_g1723 , _2170_g1723 , saturate( ( ENUM173_g1723 - 1.0 ) ));
			half THREE27_g1723 = lerpResult271_g1723;
			o.Smoothness = ( ( 1.0 - tex2D( _RoughnessTexture, uv0_MainTex ).r ) * lerpResult763 * THREE27_g1723 );
			...
			float temp_output_67_0_g1718 = Opacity156;
			float _176_g1721 = temp_output_67_0_g1718;
			float temp_output_23_0_g1719 = ( pow( ( distance( _WorldSpaceCameraPos , ase_worldPos ) / _CrossfadeDistance ) , _CrossfadeDistanceExponent ) - ( 1.0 - _CrossfadeScale ) );
			float temp_output_24_0_g1719 = saturate( temp_output_23_0_g1719 );
			float temp_output_50_0_g1718 = ( temp_output_24_0_g1719 * 1.0 );
			float lerpResult62_g1718 = lerp( temp_output_67_0_g1718 , temp_output_50_0_g1718 , temp_output_50_0_g1718);
			float _1171_g1721 = lerpResult62_g1718;
			float ENUM173_g1721 = (float)_CrossfadeMode;
			float lerpResult265_g1721 = lerp( _176_g1721 , _1171_g1721 , saturate( ENUM173_g1721 ));
			float4 ase_screenPos = i.screenPosition;
			float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
			float2 clipScreen60_g1718 = ase_screenPosNorm.xy * _ScreenParams.xy;
			float dither60_g1718 = Dither8x8Bayer( fmod(clipScreen60_g1718.x, 8), fmod(clipScreen60_g1718.y, 8) );
			float temp_output_7_0_g1720 = 0.15;
			dither60_g1718 = step( dither60_g1718, saturate( ( ( ( 1.0 - temp_output_50_0_g1718 ) - temp_output_7_0_g1720 ) / ( 0.85 - temp_output_7_0_g1720 ) ) ) );
			float _2170_g1721 = ( temp_output_67_0_g1718 * dither60_g1718 );
			float temp_output_263_0_g1721 = ( ENUM173_g1721 - 1.0 );
			float lerpResult258_g1721 = lerp( lerpResult265_g1721 , _2170_g1721 , saturate( temp_output_263_0_g1721 ));
			float2 clipScreen52_g1718 = ase_screenPosNorm.xy * _ScreenParams.xy;
			float dither52_g1718 = Dither8x8Bayer( fmod(clipScreen52_g1718.x, 8), fmod(clipScreen52_g1718.y, 8) );
			float smoothstepResult46_g1718 = smoothstep( 0.0 , 1.0 , unity_LODFade.x);
			dither52_g1718 = step( dither52_g1718, ( smoothstepResult46_g1718 * smoothstepResult46_g1718 ) );
			float temp_output_55_0_g1718 = ( 1.0 - dither52_g1718 );
			float _3169_g1721 = ( lerpResult62_g1718 * saturate( ( temp_output_55_0_g1718 + temp_output_55_0_g1718 ) ) );
			float lerpResult262_g1721 = lerp( lerpResult258_g1721 , _3169_g1721 , saturate( ( temp_output_263_0_g1721 - 1.0 ) ));
			half FOUR16_g1721 = lerpResult262_g1721;
			float Crossfade740 = FOUR16_g1721;
...
/*ASEBEGIN
Version=17300
2023;108.5;1664;832;5007.912;1131.468;2.936083;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1286;-2142.534,1897.973;Inherit;False;PWSF Crossfade;5;;1718;bafe90066fae854429c3522bf9848111;0;1;67;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1288;-2030.429,209.1758;Inherit;False;PWSF Enum Switch;-1;;1724;3e9cc2aefa7c15f46bb8ad0edeb00b30;1,34,2;9;134;FLOAT;0;False;146;FLOAT;0;False;133;FLOAT;0;False;144;FLOAT;0;False;143;FLOAT;0;False;155;FLOAT;0;False;156;FLOAT;0;False;150;FLOAT;0;False;158;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1287;-1804.13,1616.776;Inherit;False;PWSF Enum Switch;-1;;1723;3e9cc2aefa7c15f46bb8ad0edeb00b30;1,34,1;9;134;FLOAT;0;False;146;FLOAT;0;False;133;FLOAT;0;False;144;FLOAT;0;False;143;FLOAT;0;False;155;FLOAT;0;False;156;FLOAT;0;False;150;FLOAT;0;False;158;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=717671A13A25036E57E972590D0012772CFCA4B3
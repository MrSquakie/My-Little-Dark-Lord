...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Simple Lit/Tree Bark"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionScale60_g2115 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g2115 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g2115 = _Time.y * MotionSpeed62_g2115;
			float2 temp_output_95_0_g2115 = ( ( (ase_worldPos).xz * MotionScale60_g2115 ) + mulTime90_g2115 );
			half MotionlAmplitude58_g2115 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float2 temp_output_92_0_g2115 = ( sin( temp_output_95_0_g2115 ) * MotionlAmplitude58_g2115 );
			float2 temp_output_160_0_g2115 = ( temp_output_92_0_g2115 + MotionlAmplitude58_g2115 + MotionlAmplitude58_g2115 );
			half3 GlobalDirection349_g2115 = ADS_GlobalDirection;
			float3 break339_g2115 = mul( unity_WorldToObject, float4( GlobalDirection349_g2115 , 0.0 ) ).xyz;
			float2 appendResult340_g2115 = (float2(break339_g2115.x , break339_g2115.z));
			half2 MotionDirection59_g2115 = appendResult340_g2115;
			half Packed_Trunk21634 = ( v.color.r * v.color.r );
			half ADS_TreeLeavesAffectMotion168_g2088 = 0.2;
			half ADS_TreeLeavesAmount157_g2088 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g2089 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g2089 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g2088 = saturate( ( ADS_TreeLeavesAmount157_g2088 - ( frac( ( localunity_ObjectToWorld0w1_g2089 + localunity_ObjectToWorld2w3_g2089 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g2088 = temp_output_142_0_g2088;
			float lerpResult156_g2088 = lerp( ADS_TreeLeavesAffectMotion168_g2088 , 1.0 , LeavesAmountSimple172_g2088);
			half MotionMask137_g2115 = ( Packed_Trunk21634 * lerpResult156_g2088 );
			float2 temp_output_94_0_g2115 = ( ( temp_output_160_0_g2115 * MotionDirection59_g2115 ) * MotionMask137_g2115 );
			float2 break311_g2115 = temp_output_94_0_g2115;
			float3 appendResult308_g2115 = (float3(break311_g2115.x , 0.0 , break311_g2115.y));
			half3 Motion_Trunk1749 = appendResult308_g2115;
			...
			half MotionVariation269_g2114 = ( _MotionVariation2 * Packed_Variation1675 );
			...
			half ADS_TreeLeavesAffectMotion168_g2090 = 0.2;
			half ADS_TreeLeavesAmount157_g2090 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g2091 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g2091 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g2090 = saturate( ( ADS_TreeLeavesAmount157_g2090 - ( frac( ( localunity_ObjectToWorld0w1_g2091 + localunity_ObjectToWorld2w3_g2091 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g2090 = temp_output_142_0_g2090;
			float lerpResult156_g2090 = lerp( ADS_TreeLeavesAffectMotion168_g2090 , 1.0 , LeavesAmountSimple172_g2090);
			half MotionMask137_g2114 = ( Packed_Branch1862 * lerpResult156_g2090 );
			...
			half Motion_Turbulence2221 = lerpResult136_g2116;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = 1;
			float temp_output_41_0_g2125 = 1.0;
			float4 ase_screenPos = i.screenPosition;
			float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
			float2 clipScreen39_g2125 = ase_screenPosNorm.xy * _ScreenParams.xy;
			float dither39_g2125 = Dither4x4Bayer( fmod(clipScreen39_g2125.x, 4), fmod(clipScreen39_g2125.y, 4) );
			float temp_output_47_0_g2125 = max( unity_LODFade.x , step( unity_LODFade.x , 0.0 ) );
			dither39_g2125 = step( dither39_g2125, temp_output_47_0_g2125 );
			#ifdef LOD_FADE_CROSSFADE
				float staticSwitch40_g2125 = ( temp_output_41_0_g2125 * dither39_g2125 );
			#else
				float staticSwitch40_g2125 = temp_output_41_0_g2125;
			#endif
			#ifdef ADS_LODFADE_DITHER
				float staticSwitch50_g2125 = staticSwitch40_g2125;
			#else
				float staticSwitch50_g2125 = temp_output_41_0_g2125;
			#endif
			clip( staticSwitch50_g2125 - _Cutoff );
		}
...
/*ASEBEGIN
Version=16800
1927;29;1906;1014;567.7368;3152.616;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;2228;1280,2512;Float;False;ADS Leaves Amount;-1;;2090;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.RangedFloatNode;1732;1280,2240;Float;False;Property;_MotionVariation2;Branch Motion Variation;50;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2227;0,2432;Float;False;ADS Leaves Amount;-1;;2088;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.RangedFloatNode;2139;1280,2160;Float;False;Property;_MotionVertical2;Branch Motion Vertical;51;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2029;1728,2400;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1561;1280,2080;Float;False;Property;_MotionScale2;Branch Motion Scale;49;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1497;2560,-16;Float;False;1489;Base_AlbedoTex;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1562;1280,2000;Float;False;Property;_MotionSpeed2;Branch Motion Speed;48;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1557;0,2080;Float;False;Property;_MotionScale;Trunk Motion Scale;44;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1555;0,1920;Float;False;Property;_MotionAmplitude;Trunk Motion Amplitude;42;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1563;1280,1920;Float;False;Property;_MotionAmplitude2;Branch Motion Amplitude;47;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1556;0,2000;Float;False;Property;_MotionSpeed;Trunk Motion Speed;43;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2234;1920,1920;Float;False;ADS Motion Generic;39;;2114;81cab27e2a487a645a4ff5eb3c63bd27;6,252,1,278,1,228,1,292,1,330,1,326,1;8;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;279;FLOAT;0;False;342;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;2233;640,1920;Float;False;ADS Motion Generic;39;;2115;81cab27e2a487a645a4ff5eb3c63bd27;6,252,0,278,0,228,0,292,0,330,0,326,0;8;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;279;FLOAT;0;False;342;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2220;-1280,2496;Float;False;ADS Global Turbulence;33;;2116;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.GetLocalVarNode;1752;2688,1920;Float;False;1749;Motion_Trunk;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1796;2688,2016;Float;False;1750;Motion_Branch;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2114;-1280,1152;Float;False;const;-1;;2119;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1802;2944,1920;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;2177;4096,-256;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Off;Base;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;2178;3712,128;Float;False;620;Main_NormalTex;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2223;2688,2208;Float;False;2221;Motion_Turbulence;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1629;3264,1920;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2232;-640,-1920;Float;False;const;-1;;2120;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1076;-1280,-2112;Float;False;1539;OUT_COLOR;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1220;3424,1920;Half;False;Motion_Output;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;745;4672,-1040;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1708;-976,-3168;Half;False;Property;_BranchMotionParameters;!!! Branch Motion Parameters !!!;46;0;Create;True;0;0;True;1;BMessage(Info, The Branch Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;550;-1280,-2688;Half;False;Property;_SrcBlend;_SrcBlend;73;1;[HideInInspector];Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1938;0,-2688;Float;False;Internal Unity Props;57;;2128;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2219;-352,-3168;Half;False;Property;_BatchingInfo;!!! BatchingInfo;55;0;Create;True;0;0;True;1;BMessage(Info, Batching is not currently supported Please use GPU Instancing instead for better performance, 0, 0);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2229;2176,-2688;Float;False;ADS Features Support;-1;;2129;217a332a46517ae4cb8ca16677bdb217;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1724;-672,-3168;Half;False;Property;_LeafMtionParameters;!!! Leaf Mtion Parameters !!!;53;0;Create;True;0;0;False;1;BMessage(Info, The Leaf Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1723;-1280,-3168;Half;False;Property;_TrunkMotionParameters;!!! Trunk Motion Parameters !!!;41;0;Create;True;0;0;True;1;BMessage(Info, The Trunk Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1471;128,-3360;Half;False;Property;_ADVANCEDD;[ ADVANCEDD ];54;0;Create;True;0;0;True;1;BCategory(Advanced);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;925;-960,-2688;Half;False;Property;_ZWrite;_ZWrite;75;1;[HideInInspector];Create;True;2;Off;0;On;1;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1934;640,-2688;Half;False;Property;_Internal_TypeTreeBark;Internal_TypeTreeBark;68;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2048;1632,-2688;Half;False;Property;_Internal_DebugVariation;Internal_DebugVariation;71;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1688;-352,-3360;Half;False;Property;_BRANCHMOTIONN;[ BRANCH MOTIONN ];45;0;Create;True;0;0;True;1;BCategory(Branch Motion);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1932;1904,-2688;Half;False;Property;_Internal_SetByScript;Internal_SetByScript;72;1;[HideInInspector];Create;True;0;0;True;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2047;464,-2688;Half;False;Property;_Internal_ADS;Internal_ADS;56;1;[HideInInspector];Create;True;0;0;True;0;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1636;-1024,2048;Half;False;Packed_Leaf;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1930;1136,-2688;Half;False;Property;_Internal_DebugMask;Internal_DebugMask;69;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2116;512,1152;Float;False;const;-1;;2123;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1473;-112,-3360;Half;False;Property;_LEAFMOTIONN;[ LEAF MOTIONN ];52;0;Create;True;0;0;False;1;BCategory(Leaf Motion);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1472;-1280,-3456;Half;False;Property;_ADSSimpleLitTreeBark;< ADS Simple Lit Tree Bark>;2;0;Create;True;0;0;True;1;BBanner(ADS Simple Lit, Tree Bark);1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2115;-384,1152;Float;False;const;-1;;2127;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;553;-1120,-2688;Half;False;Property;_DstBlend;_DstBlend;74;1;[HideInInspector];Create;True;0;0;False;0;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;645;3584,-1024;Float;True;Property;_SurfaceTex;Trunk Surface;13;1;[NoScaleOffset];Create;False;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;2230;-448,-1920;Float;False;ADS LODFade Dither;-1;;2125;f1eaf6a5452c7c7458970a3fc3fa22c1;1,44,0;1;41;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1931;1376,-2688;Half;False;Property;_Internal_DebugMask2;Internal_DebugMask2;70;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1935;896,-2688;Half;False;Property;_Internal_LitSimple;Internal_LitSimple;67;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2236;224,-2688;Float;False;ADS Internal Version;0;;2126;858e1f7f7bf8673449834f9aaa5bae83;0;0;1;FLOAT;5
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-128,-2176;Float;False;True;2;Float;ADSShaderGUI;300;0;Lambert;BOXOPHOBIC/Advanced Dynamic Shaders/Simple Lit/Tree Bark;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;True;False;False;False;True;Back;0;False;925;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;True;0;True;Opaque;;Geometry;All;True;True;True;False;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;True;550;10;True;553;0;1;False;550;10;False;553;0;True;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;300;Utils/ADS Fallback;-1;-1;-1;-1;0;False;0;0;False;743;-1;0;True;862;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.CommentaryNode;1542;-1280,1792;Float;False;4913.041;100;Tree Motion;0;;0.03448272,1,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;712;-1280,-1152;Float;False;1745.222;100;Main UVs;0;;0.4980392,1,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;1937;0,-2816;Float;False;2402.672;100;Internal Only;0;;1,0,0,1;0;0
...
WireConnection;2234;220;1563;0
WireConnection;2234;221;1562;0
WireConnection;2234;222;1561;0
WireConnection;2234;218;1733;0
WireConnection;2234;136;2029;0
WireConnection;2234;279;2139;0
WireConnection;2233;220;1555;0
WireConnection;2233;221;1556;0
WireConnection;2233;222;1557;0
WireConnection;2233;136;2024;0
WireConnection;1495;0;1496;0
WireConnection;1495;1;1497;0
WireConnection;1495;2;1499;0
WireConnection;1750;0;2234;0
WireConnection;1898;0;1536;0
WireConnection;1896;0;1495;0
WireConnection;1749;0;2233;0
...
WireConnection;0;10;2230;0
WireConnection;0;11;1221;0
ASEEND*/
//CHKSM=AA3FBAC733C90AE64964889CAE064F5F2D89F9AF
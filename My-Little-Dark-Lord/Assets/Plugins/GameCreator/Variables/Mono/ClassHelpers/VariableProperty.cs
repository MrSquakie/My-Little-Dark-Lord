namespace GameCreator.Variables
{
    ...
    public class VariableProperty
    {
        ...
        {
            return this.list.GetGameObject(null);
        }

        public Variable.DataType GetVariableDataType()
        {
            switch (this.variableType)
            {
                ...
                case GetVarType.LocalVariable: 
                    return this.local.GetDataType(this.GetLocalVariableGameObject());

                case GetVarType.ListVariable:
                    return this.list.GetDataType(this.GetListVariableGameObject());
            }

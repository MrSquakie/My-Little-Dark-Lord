namespace GameCreator.Core
{
    ...
    {
        public const string DATE_FMT = "dd/MM/yyyy HH:mm:ss";
        ...
        [Serializable]
        private class Profiles : SerializableDictionaryBase<int, Profile> { }
        ...
        private void OnSave(int profile)
        {
            ...
            this.profiles[profile].date = DateTime.Now.ToString(DATE_FMT);
            DatabaseGeneral
                .Load()
                .GetDataProvider()

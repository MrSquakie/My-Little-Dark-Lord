namespace GameCreator.Characters
{
    ...
    public class CharacterAnimator : MonoBehaviour
    {
        ...
        {
            this.characterAnimation.PlayGesture(clip, avatarMask, speed, transitionIn, transitionOut);
        }
        ...
        {
            this.characterAnimation.SetState(state, avatarMask, weight, time, speed, layer);
        }

        public void SetState(RuntimeAnimatorController rtc, AvatarMask avatarMask,
                             float weight, float time, float speed, CharacterAnimation.Layer layer)
        {
            this.characterAnimation.SetState(rtc, avatarMask, weight, time, speed, layer);
        }

        public void SetState(AnimationClip clip, AvatarMask avatarMask,
                             float weight, float time, float speed, CharacterAnimation.Layer layer)
        {
            this.characterAnimation.SetState(clip, avatarMask, weight, time, speed, layer);
        }
        ...
        {
            return this.characterAnimation.GetState(layer);
        }

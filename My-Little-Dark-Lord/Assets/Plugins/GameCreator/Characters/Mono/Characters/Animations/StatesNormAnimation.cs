...
public class StatesNormAnimation
{
    ...
    public void SetState(RuntimeAnimatorController rtc, float weight, float time, float speed)
    {
    ...
    public void SetState(AnimationClip clip, float weight, float time, float speed)
    {
    ...
    public void Update()
    {
        ...
        {
            this.mixer.SetInputWeight(0, this.currentWeight);
    ...
    private void SetState(Playable input, float weight, float time, float speed)
    {

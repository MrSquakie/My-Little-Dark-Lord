...
public class GestureAnimation
{
    ...
    public virtual void PlayGesture(AnimationClip clip, float speed, 
        float transitionIn = TRANSITION, float gestureTransitionOut = TRANSITION)
    {
        if (clip == null) return;
        ...
        this.gestureTransitionOut = gestureTransitionOut;
    }

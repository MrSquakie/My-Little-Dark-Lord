    ...
    public class SpawnerSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public Spawner CreateSpawner(bool autoAddResources = false, Transform targetTransform = null)
        {
            ...
            if (autoAddResources)
            {
                ...
                GaiaDefaults.GetPrototypes(new List<BiomeSpawnerListEntry>() { new BiomeSpawnerListEntry() {m_spawnerSettings = this } }, ref terrainLayers, ref terrainDetails, ref terrainTrees, Terrain.activeTerrain);

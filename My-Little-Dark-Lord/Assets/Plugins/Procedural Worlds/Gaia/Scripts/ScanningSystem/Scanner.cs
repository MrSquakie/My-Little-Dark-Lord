...
namespace Gaia
{
    ...
    public class Scanner : MonoBehaviour
    {
        ...
        public string SaveScan()
        {
            ...
            GaiaUtils.CompressToMultiChannelFileImage(path, m_scanMap, m_scanMap, m_scanMap, null, TextureFormat.RGBAFloat, GaiaConstants.ImageFileType.Exr);

            //Gaia.GaiaUtils.CompressToSingleChannelFileImage(m_scanMap.Heights(), path, Gaia.GaiaConstants.fmtHmTextureFormat, false, true);

            path = GaiaDirectories.GetStampInstanceDataDirectory(m_featureType, m_featureName);

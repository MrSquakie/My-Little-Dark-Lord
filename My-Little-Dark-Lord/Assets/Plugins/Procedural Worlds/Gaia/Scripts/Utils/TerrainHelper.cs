...
namespace Gaia
{
    ...
    public class TerrainHelper : MonoBehaviour
    {
        ...
        public static bool GetTerrainBounds(ref Bounds bounds)
        {
            ...
            Vector3 accumulatedCenter = new Vector3();

            foreach (Terrain t in Terrain.activeTerrains)
            {
                accumulatedCenter += t.transform.position + t.terrainData.bounds.extents;
            }

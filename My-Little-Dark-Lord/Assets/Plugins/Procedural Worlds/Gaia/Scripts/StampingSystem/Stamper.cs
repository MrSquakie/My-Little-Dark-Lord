...
#pragma warning restore 414
        ...
        public void Stamp()
        {
            ...
            //Update the session
            AddToSession(GaiaOperation.OperationType.Stamp, "Stamper: " + m_settings.m_operation.ToString());

            
            GaiaMultiTerrainOperation operation = new GaiaMultiTerrainOperation(currentTerrain, transform, GetStamperRange(currentTerrain), true);
        ...
        private float GetStamperRange(Terrain currentTerrain)
        {
        ...
        public void LoadSettings(StamperSettings settingsToLoad)
        {
        ...
        public void FitToTerrain()
        {
            ...
            if (Gaia.TerrainHelper.GetTerrainBounds(t, ref b))
            {
                ...
                m_settings.m_y = b.center.y * 0.2f;
        ...
        public void AddToSession(GaiaOperation.OperationType opType, string opName)
        {
            ...
            if (sessionMgr != null && sessionMgr.IsLocked() != true)
            {
                ...
                //{
                //    //op.serializedObject = new SerializedObject(this);
...
//#endif
        ...
        public void UpdateMinMaxHeight()
        {
            ...
            gsm.GetWorldMinMax(ref m_minCurrentTerrainHeight, ref m_maxCurrentTerrainHeight);
        ...
        public void FitToAllTerrains()
        {
            ...
            if (TerrainHelper.GetTerrainBounds(ref b))
            {
                ...
                m_settings.m_x = b.center.x;
                m_settings.m_y = b.center.y;
                m_settings.m_z = b.center.z;
                
                m_settings.m_width = b.size.x/GetCurrentTerrain().terrainData.size.x * 100f;
                m_stampDirty = true;
                DrawStampPreview();
            }
        }
        ...
        void DrawGizmos(bool isSelected)
        {
            ...
            if (transform.hasChanged && m_settings !=null)
            {
            ...
            if (m_seaLevel != GaiaSessionManager.GetSessionManager(false).GetSeaLevel())
            {
                m_seaLevel = GaiaSessionManager.GetSessionManager(false).GetSeaLevel();
                m_stampDirty = true;
            }
        ...
        public RenderTexture ApplyBrushInternal(GaiaMultiTerrainOperation operation)
        {
            ...
            if (m_stampDirty || m_cachedRenderTexture == null)
            {
                ...
                RenderTexture localinputTexture = RenderTexture.GetTemporary(operation.RTheightmap.descriptor);
                RenderTexture globalInputTexture = RenderTexture.GetTemporary(operation.RTheightmap.descriptor);
                ...
                RenderTexture localOutputTexture = RenderTexture.GetTemporary(operation.RTheightmap.descriptor);
                RenderTexture globalOutputTexture = RenderTexture.GetTemporary(operation.RTheightmap.descriptor);
                ...
                switch (m_settings.m_operation)
                {
                    ...
                    case GaiaConstants.FeatureOperation.PowerOf:
                        ...
                        //    heightTransformMat.SetTexture("_BrushTex", localOutputTexture);
                        //else
                        //    heightTransformMat.SetTexture("_BrushTex", inputTexture);
                    ...
                    case GaiaConstants.FeatureOperation.Smooth:
                        ...
                        smoothMat.SetTexture("_BrushTex", localOutputTexture);
                    ...
                    default:
                        ...
                        float relativeYPos = Mathf.Lerp(-0.5f, 0.5f, Mathf.InverseLerp(operation.m_originTerrain.transform.position.y - operation.m_originTerrain.terrainData.size.y, operation.m_originTerrain.transform.position.y + operation.m_originTerrain.terrainData.size.y, m_settings.m_y));

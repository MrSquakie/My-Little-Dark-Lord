...
namespace Invector.vCharacterController
{
    public abstract class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        {
            if (input != Vector2.zero || customAction) return;
        ...
        protected virtual void LocomotionAnimation()
        {
            ...
            if (isStrafing)
            {
                ...
                animator.SetFloat("InputHorizontal", !stopMove  ? direction : 0f, 0.25f, Time.deltaTime);
                animator.SetFloat("InputVertical", !stopMove  ? speed : 0f, 0.25f, Time.deltaTime);
        ...
        protected virtual void RollAnimation()
        {
            if (isRolling)
            {
                if(inCrouchArea) autoCrouch = true;

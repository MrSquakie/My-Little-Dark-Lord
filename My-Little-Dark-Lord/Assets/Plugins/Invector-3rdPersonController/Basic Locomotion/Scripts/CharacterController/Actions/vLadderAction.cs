...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vLadderAction : vActionListener
    {
        ...
        void AutoEnterLadder()
        {
            ...
            if (ladderAction.autoAction && tpInput.cc.input != Vector2.zero && !tpInput.cc.customAction)
            {
        ...
        void ResetPlayerSettings()
        {
            ...
            tpInput.cc.animator.SetFloat("InputMagnitude", 0f);
            tpInput.cc.enabled = true;
            tpInput.cc._currentSpeed = 0;
            tpInput.cc._currentDirection = 0;         

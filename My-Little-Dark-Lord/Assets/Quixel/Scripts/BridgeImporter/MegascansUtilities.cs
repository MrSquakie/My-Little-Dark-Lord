    ...
    public class MegascansUtilities : MonoBehaviour {
        ...
        public static int GetMeshChildrenCount(List<string> importedMeshpaths)
        {
            try
            {
                ...
                {
                    UnityEngine.Object loadedGeometry = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(importedMeshpaths[1]);
        ...
        public static void CalculateNumberOfOperations(JObject assetData, int dispType, int texPack, int shaderType, bool generateTerrainNormal, bool hasBillboardLODOnly)
        {
            ...
            texCount = generateTerrainNormal ? texCount++ : texCount;
